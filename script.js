...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: 'bd1d49ca22844e30a31fd4c5e88c0057',
        src: jokeString,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
  let joke = '';
  const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Programming,Dark,Pun?blacklistFlags=nsfw,religious,political,racist,sexist';
  try {
